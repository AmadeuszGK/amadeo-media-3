          ...
          <div className="container">
            ...
            <div className="policy__section">
              ...
              <p className="policy__text">
                ...
                adresem url: www.amadeomedia.com
                <br />
                2. Operatorem serwisu oraz Administratorem danych osobowych
                jest: Amadeo Media Amadeusz Grzsiak 59-800 Lubań
                <br />
                ...
                <br />- Poprzez zapisywanie w urządzeniach końcowych plików
              ...
              <p className="policy__text">
                1. Miejsca logowania i wprowadzania danych osobowych są
                chronione w warstwie transmisji (certyfikat SSL). Dzięki temu
              ...
              <p className="policy__text">
                ...
                <br />
                2. Twoje dane osobowe przetwarzane przez Administratora nie
                ...
                obsługi Serwisu.
                <br />
                7. W stosunku do Ciebie mogą być podejmowane czynności
                ...
                rozumieniu przepisów o ochronie danych osobowych. Oznacza to, że
                nie przesyłamy ich poza teren Unii Europejskiej.
              </p>

              <h2>5. Informacje w formularzach</h2>
              <p className="policy__text">
                1. Serwis zbiera informacje podane dobrowolnie przez
              ...
              <p className="policy__text">
                1. Operator stosuje analizę statystyczną ruchu na stronie,
                ...
                wykorzystaniu ciasteczek w urządzeniu końcowym użytkownika. W
                zakresie informacji o preferencjach użytkownika gromadzonych
              ...
              <p className="policy__text">
                ...
                <br />
                2. Pliki cookies (tzw. „ciasteczka”) stanowią dane
                ...
                <br />
                6. Oprogramowanie do przeglądania stron internetowych
                ...
                Szczegółowe informacje na ten temat zawiera pomoc lub
                dokumentacja przeglądarki internetowej.
                <br />
                7. Ograniczenia stosowania plików cookies mogą wpłynąć na
